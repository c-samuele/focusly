...
Focusly nasce come progetto orientato alla pianificazione dello studio attraverso una web application in grado di organizzare task, gruppi tematici e milestone all'interno di un'unica interfaccia. L'idea di partenza é offrire uno strumento semplice per l'utente finale, con autenticazione remota, persistenza cloud e possibilità di mantenere una continuità d'uso anche in presenza di dati locali salvati nel browser.
